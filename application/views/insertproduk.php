                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="<?= base_url('admin/insertproduk2') ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="deskripsi" rows="3" placeholder="Text Area" id="deskripsi"></textarea>
                                </div>
                                <div class="form-group">
